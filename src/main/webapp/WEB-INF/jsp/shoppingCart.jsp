...
<html>
	...
	<body>
			...
			<div class="product">
				<div class="product-box">
					...
					<div class="product-sx">
						<a href="###">
							<img src="${pageContext.request.contextPath }/img/a3.png" class="product-img" />
						...
						<div class="product-del"><img src="${pageContext.request.contextPath }/img/deleteico.png"/></div>
					</div>
				</div>
				<div class="product-box">
					...
					<div class="product-sx">
						<a href="###">
							<img src="${pageContext.request.contextPath }/img/a1.png" class="product-img" />
				...
				<div class="product-box">
					...
					<div class="product-sx">
						<a href="###">
							<img src="${pageContext.request.contextPath }/img/a2.png" class="product-img" />
				...
				<div class="product-box">
					...
					<div class="product-sx">
						<a href="###">
							<img src="${pageContext.request.contextPath }/img/a4.png" class="product-img" />
		...
		<div class="kon-cat">
			<div class="catkon">
				<div class="kon-box">
					<div class="kon-hz">
						<img src="${pageContext.request.contextPath }/img/cart-air.png" />
						<span class="kon-wz">购物车什么都没有</span>
						<a href="${pageContext.request.contextPath }/product/productAll.do" class="kon-lj">去逛逛</a>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="${pageContext.request.contextPath }/js/shoppingcart.js" type="text/javascript" charset="utf-8"></script>
</html>
